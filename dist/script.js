...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.eq = function (n) {
  let current = this[n];
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.html = function (elem) {
  if (!elem) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.index = function (element) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.addClasses = function (...selector) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.removeClasses = function (...selector) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.addClass = function (selector) {
  for (let i = 0; i < this.length; i++) {
    this[i].classList.add(selector);
  }
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.removeClass = function (selector) {
  for (let i = 0; i < this.length; i++) {
    this[i].classList.remove(selector);
  }
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.toggleClass = function (selector) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.on = function (eventName, callback, intercept = false) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.off = function (eventName, callback, intercept = false) {
  if (!eventName || !callback) {
    return this;
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.click = function () {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.div').find('.i');
